    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">Select your lucky number and amount to win big!</p>
          
          {/* Next Result Time - Prominent Display */}
          {nextResultTime && (
            <div className="mt-6 mb-4 flex justify-center">
              <div className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-6 py-3 rounded-full shadow-lg animate-pulse border-2 border-yellow-300">
          ...
          <div className="mt-4 flex items-center justify-center space-x-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/25"
            >
              💰 Add Money
            </button>
            <button
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            <h2 className="text-2xl font-bold mb-6 text-center">Choose Your Bet</h2>
            
            {/* Number Selection */}
            <div className="mb-8">
              <h3 className="text-lg font-semibold mb-4 text-yellow-400">Select Your Lucky Number (1-20)</h3>
              <div className="grid grid-cols-5 gap-3">
                {numbers.map(num => (
                  <button
                    key={num}
                    onClick={() => setSelectedNumber(num)}
                    className={`w-12 h-12 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-110 ${
                      selectedNumber === num
            ...
            {/* Amount Selection */}
            <div className="mb-8">
              <h3 className="text-lg font-semibold mb-4 text-yellow-400">Select Bet Amount</h3>
              <div className="grid grid-cols-3 gap-3">
                {amounts.map(amount => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-300">{amount.multiplier}x</div>
                  </button>
                ))}
              </div>
            </div>
            ...
            {selectedAmount && selectedAmount > balance && (
              <div className="mt-4 p-3 bg-red-500/20 text-red-400 rounded-lg text-center border border-red-400/30">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            <h2 className="text-2xl font-bold mb-6 text-center">Your Current Bets</h2>
            
            {betsLoading ? (
              <div className="flex items-center justify-center py-8">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-yellow-400"></div>
                <span className="ml-2 text-gray-300">Loading bets...</span>
              </div>
            ) : pendingBets.length === 0 ? (
              <div className="text-center py-8">
                <div className="text-6xl mb-4">🎲</div>
                <div className="text-gray-400 text-lg">No active bets for this round</div>
                <div className="text-gray-500 text-sm mt-2">Place your first bet to get started!</div>
              </div>
            ) : (
                  ...
                  <div key={bet._id} className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold">Number {bet.number}</div>
        ...
        <div className="mt-8 bg-white/5 rounded-2xl p-6 border border-white/10">
          <h3 className="text-xl font-bold mb-4 text-center text-yellow-400">🎯 Multiplier System</h3>
          <div className="grid grid-cols-3 md:grid-cols-9 gap-4">
            {amounts.map(amount => (
              <div key={amount.value} className="text-center p-3 bg-white/5 rounded-lg">
                <div className="font-bold text-lg">₹{amount.value}</div>
                <div className="text-yellow-400 font-semibold">{amount.multiplier}x</div>
